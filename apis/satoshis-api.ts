...
export const SatoshisApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getSatoshi(number: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20030>>> {
...
export const SatoshisApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getSatoshi(number: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20030>> {
...
export class SatoshisApi extends BaseAPI {
     ...
     */
    public async getSatoshi(number: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20030>> {
