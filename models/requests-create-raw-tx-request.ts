...
import { RequestsCreateRawTxInput } from './requests-create-raw-tx-input';
import { RequestsCreateRawTxOutput } from './requests-create-raw-tx-output';
 /**
 * 
 *
 * @export
 * @interface RequestsCreateRawTxRequest
 */
export interface RequestsCreateRawTxRequest {

    /**
     * The inputs for the transaction
     *
     * @type {Array<RequestsCreateRawTxInput>}
     * @memberof RequestsCreateRawTxRequest
     */
    inputs: Array<RequestsCreateRawTxInput>;
     ...
     *
     * @type {Array<RequestsCreateRawTxOutput>}
     * @memberof RequestsCreateRawTxRequest
     */
    outputs: Array<RequestsCreateRawTxOutput>;
